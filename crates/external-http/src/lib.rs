...
pub fn handler_with_config(config: ExternalHttpConfig) -> ExternalRequestHandler {
...
pub async fn perform_external_stream_request(
...
pub async fn perform_external_request(
    request: ExternalRequest,
